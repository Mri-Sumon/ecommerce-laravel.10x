                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <span>To change password you have to enter a value, otherwise live blank.</span>
                                    <p></p>	
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" value="{{$user->phone}}" name="phone" id="phone" class="form-control" placeholder="Phone">
                                    <p></p>	
                                </div>
                            </div>									
